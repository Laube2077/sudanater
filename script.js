document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        ...
        "フィクションのキャラクターですか？", "動物のキャラクターですか？", "人間以外の種族ですか？", "歌手・ミュージシャンですか？",
        "俳優・女優ですか？", "YouTuberですか？", "スポーツ選手ですか？", "サッカー選手ですか？", "野球選手ですか？",
        "政治家ですか？", "歴史上の人物ですか？", "作家・漫画家ですか？", "お笑い芸人ですか？", "声優ですか？",
        "ゲーム実況者ですか？", "アイドルグループのメンバーですか？", "学生ですか？", "先生や師匠のような立場ですか？",
        "社長やリーダーですか？", "髪の毛は黒いですか？", "髪の毛は金髪ですか？", "髪の毛はピンクや青など奇抜な色ですか？",
        "髪は長いですか？", "メガネをかけていますか？", "ヒゲを生やしていますか？", "帽子をよくかぶっていますか？",
        "マスクや仮面で顔を隠していますか？", "太っていますか？", "名前に「ん」がつきますか？", "名前にカタカナが入っていますか？",
        "名前に数字が入っていますか？", "関西弁を話しますか？", "制服を着ていますか？", "週刊少年ジャンプの漫画に関係していますか？",
        "ジブリ作品のキャラクターですか？", "ディズニーのキャラクターですか？", "任天堂のゲームに関係していますか？",
        "ファイナルファンタジーシリーズに関係していますか？", "バトル系の作品に登場しますか？", "異世界が舞台の作品に関係していますか？",
        "SF作品の登場人物ですか？", "ファンタジーの世界の住人ですか？", "ホラー作品に関係していますか？",
        "スポーツがテーマの作品に登場しますか？", "現代の日本が舞台ですか？", "特定の組織に所属していますか？",
        "海賊ですか？", "忍者ですか？", "戦いますか？", "魔法を使いますか？", "超能力を持っていますか？", "空を飛びますか？",
        "歌を歌いますか？", "楽器を演奏しますか？", "乗り物を操縦しますか？", "料理をしますか？", "剣や刀を使いますか？",
        "銃を使いますか？", "巨大なロボットに乗りますか？", "普段は正体を隠して生活していますか？", "ペットや相棒となる動物がいますか？",
        "主人公ですか？", "悪役・敵役ですか？", "主人公の仲間ですか？", "ライバルがいますか？", "兄弟姉妹がいますか？",
        "チームで行動することが多いですか？", "王族や貴族の家系ですか？", "頭が良いですか？", "熱血キャラクターですか？",
        "クールな性格ですか？", "面白いことを言いますか？", "人々を助ける役割ですか？", "ミステリアスな雰囲気ですか？",
        "食べることが好きですか？", "インターネットで有名になりましたか？", "お金持ちですか？", "子どもに人気がありますか？",
        "もともとは小説の登場人物ですか？", "実写化されたことがありますか？", "シリーズ作品に登場しますか？",
        "21世紀になってから登場しましたか？", "海外でも人気がありますか？", "グッズがたくさん販売されていますか？",
        "決め台詞がありますか？", "物語の途中で死んでしまいますか？"
    ];
    ...
    // 特別な質問が登場する確率（0.15 = 15%）
    const secretQuestionChance = 0.15; 

    function changeQuestion() {
        // 15%の確率で当たりを引いたかどうかを判定
        if (Math.random() < secretQuestionChance) {
            // 当たった場合：特別な質問を表示
            questionText.textContent = secretQuestion;
        } else {
            // 外れた場合：通常の質問リストからランダムに選ぶ
